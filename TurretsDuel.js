...
function playGame() {
    ...
    song.volume = 0.3;
    var pause = 0;
    var enemy_shoot1 = new Audio("https://saantonandre.github.io/sfx/enemy_shoot1.wav");
    var enemy_shoot2 = new Audio("https://saantonandre.github.io/sfx/enemy_shoot2.wav");
    var enemy_shoot3 = new Audio("https://saantonandre.github.io/sfx/enemy_shoot3.wav");
    var player_shoot = new Audio("https://saantonandre.github.io/sfx/player_shoot.wav");
    var player_buffed_shoot = new Audio("https://saantonandre.github.io/sfx/player_buffed_shoot.wav");
    var player_damaged = new Audio("https://saantonandre.github.io/sfx/player_damaged.wav");

    var enemy_shoot1a = new Audio("https://saantonandre.github.io/sfx/enemy_shoot1.wav");
    var enemy_shoot2a = new Audio("https://saantonandre.github.io/sfx/enemy_shoot2.wav");
    var enemy_shoot3a = new Audio("https://saantonandre.github.io/sfx/enemy_shoot3.wav");
    var player_shoota = new Audio("https://saantonandre.github.io/sfx/player_shoot.wav");
    var player_buffed_shoota = new Audio("https://saantonandre.github.io/sfx/player_buffed_shoot.wav");
    var player_damageda = new Audio("https://saantonandre.github.io/sfx/player_damaged.wav");
